...
def system_prompt_parts() -> tuple[str, str]:
    ...
    if admin:
        ...
        extra = (
            ...
            "HTML pages in app/, and repo_commit_push. To ship it, call deploy_self (gated) after the push: it builds the "
            "committed HEAD on Cloud Build and rolls a new revision of the nikki Cloud Run service in ~5 minutes; "
            "follow it with build_log. Never claim a change to your own UI is "
